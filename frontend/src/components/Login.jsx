...
function Login() {
    ...
    const signupHandler = async (e) => {
        ...
        try {
            ...
            console.log("Response received:", res); // Log full response object
            ...
            if (res.data.success) {
                ...
                console.error("Login failed, response message:", res.data.message);
                toast.error("Login failed!");
            }
        } catch (error) {
            if (error.response) {
                console.error("Login error response:", error.response.data);
                toast.error(`Error: ${error.response.data.message || "An error occurred during login"}`);
  ...
  loading ? (
    <button
      type="button"
      className="w-full bg-gradient-to-r from-gray-500 to-gray-700 text-white font-bold rounded-xl py-3 mt-6 flex items-center justify-center transition-all duration-300"
      disabled
    >
    ...
    <button
      type="submit"
      className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl py-3 mt-6 transition-all duration-300 transform hover:scale-105 shadow-lg"
    >
      Login
    </button>
  )
